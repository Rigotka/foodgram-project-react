...
class Tag(models.Model):
    ...
    color = models.CharField(max_length=200, blank=False, null=True, unique=True)
...
class Ingredient(models.Model):
    name = models.CharField(max_length=200, blank=False, null=True, unique=True)
    measurement_unit =  models.CharField('единицы изменения',max_length=50)
...
class ShoppingCart(models.Model):
    ...
    recipe = models.ForeignKey(Recipe, on_delete=models.CASCADE,related_name="recipe_shopping_cart")
    date = models.DateTimeField(auto_now_add=True)
